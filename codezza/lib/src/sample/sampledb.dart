...
class TestData {
  ...
  static final user1Dairy = [
    Diary(
      ...
      dTitle: 'user1 일기제목1',
      dText: 'user1 일기내용1',
      dThumbnail: 'https://tinyurl.com/yjfnoonz',
      dPrivate: 'N',
      dDiaryType: '개인',
      insID: 'user1',
      insDT: DateTime.parse('2020-03-14'),
    ...
    Diary(
      ...
      dTitle: 'user1 일기제목2',
      dText: 'user1 일기내용2',
      dThumbnail: 'https://tinyurl.com/yg2oqtmr',
      dPrivate: 'N',
      dDiaryType: '개인',
      insID: 'user1',
    ...
    Diary(
      ...
      dTitle: 'user1 일기제목3',
      dText: 'user1 일기내용3',
      dThumbnail: 'https://tinyurl.com/yhbc5tjl',
      dPrivate: 'N',
      dDiaryType: '개인',
      insID: 'user1',
      insDT: DateTime.parse('2020-03-16'),
    ...
    Diary(
      ...
      dTitle: 'user1 일기제목4',
      dText: 'user1 일기내용4',
      dThumbnail: 'https://tinyurl.com/yzagahbw',
      dPrivate: 'N',
      dDiaryType: '개인',
      insID: 'user1',
    ...
    Diary(
      ...
      dTitle: 'user1 일기제목5',
      dText: 'user1 일기내용5',
      dThumbnail: 'https://tinyurl.com/yegnv6xo',
      dPrivate: 'N',
      dDiaryType: '개인',
      insID: 'user1',
